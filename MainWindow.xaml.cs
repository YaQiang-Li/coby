...
using CefSharp.Wpf.Copy.Controls;
...
namespace CefSharp.Wpf.Copy
{
    ...
    {
        private const string DefaultUrlForAddedTabs = "https://www.taobao.com";

        public static string strInnerHtml = "";
        public static string strMessageHtml = "";
